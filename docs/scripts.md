...
| `fm-dashboard.sh`        | Project the fleet snapshot to the captain's mission-control state document (schema `fm-mission-control.v1`) and render its single-viewport page |
